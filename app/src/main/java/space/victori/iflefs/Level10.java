...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimgfon.setBackgroundResource((R.drawable.previewbackground10));
        ...
        textdescriptionEnd.setText(R.string.leveltenend);
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground10));
        ...
        img_left.setImageResource(array.images10[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts10[numLeft]);//Достаём из массива текст
