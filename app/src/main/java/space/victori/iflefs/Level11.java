...
public class Level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescriptionEnd.setText(R.string.levelelevenend);

        //Установка картинки в диалоговый фон
        LinearLayout previewimgfonend= (LinearLayout) dialogEnd.findViewById(R.id.dialogfon);
        previewimgfonend.setBackgroundResource((R.drawable.previewbackground11));
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground11));
        ...
        img_left.setImageResource(array.images11[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts11[numLeft]);//Достаём из массива текст

        numRight = random.nextInt(12);
        //Если числа равны
        while (array.strong11[numLeft]==array.strong11[numRight]){
            numRight = random.nextInt(12);
        }
        img_right.setImageResource(array.images11[numRight]);
        text_right.setText(array.texts11[numRight]);
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (array.strong11[numLeft]>array.strong11[numRight]){
