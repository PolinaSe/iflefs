...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescriptionEnd.setText(R.string.levelnineend);

        //Установка картинки в диалоговый фон
        LinearLayout previewimgfonend= (LinearLayout) dialogEnd.findViewById(R.id.dialogfon);
        previewimgfonend.setBackgroundResource((R.drawable.previewbackground9));
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground9));
        ...
        btnreplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level9.this, Level9.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
                }
        ...
        img_left.setImageResource(array.images9[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts9[numLeft]);//Достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images9[numRight]);//Достаём из массива картинку
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images9[numRight]); //Достаём из массива картинку
                        img_right.startAnimation(a);
                        text_right.setText(array.texts9[numRight]); //Достаём из массива текст
