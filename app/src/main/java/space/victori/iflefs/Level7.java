...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource((R.drawable.previewimg7));

        //Установка картинки в диалоговый фон
        LinearLayout previewimgfon= (LinearLayout) dialog.findViewById(R.id.dialogfon);
        previewimgfon.setBackgroundResource((R.drawable.previewbackground7));
        ...
        textdescriptionEnd.setText(R.string.levelsevenend);

        //Установка картинки в диалоговый фон
        LinearLayout previewimgfonend= (LinearLayout) dialogEnd.findViewById(R.id.dialogfon);
        previewimgfonend.setBackgroundResource((R.drawable.previewbackground7));
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground7));
        ...
        img_left.setImageResource(array.images7[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts7[numLeft]);//Достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images7[numRight]);//Достаём из массива картинку
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images7[numRight]); //Достаём из массива картинку
                        img_right.startAnimation(a);
                        text_right.setText(array.texts7[numRight]); //Достаём из массива текст
