...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_left.setImageResource(array.images5[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts5[numLeft]);//Достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images5[numRight]);//Достаём из массива картинку
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images5[numRight]); //Достаём из массива картинку
                        img_right.startAnimation(a);
                        text_right.setText(array.texts5[numRight]); //Достаём из массива текст
