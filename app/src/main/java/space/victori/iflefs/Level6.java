...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimgfon.setBackgroundResource((R.drawable.previewbackground6));
        ...
        previewimgfonend.setBackgroundResource((R.drawable.previewbackground6));
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground6));
        ...
        img_left.setImageResource(array.images6[numLeft]);//Достаём из массива картинку
        text_left.setText(array.texts6[numLeft]);//Достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images6[numRight]);//Достаём из массива картинку
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        img_right.setImageResource(array.images6[numRight]); //Достаём из массива картинку
                        img_right.startAnimation(a);
                        text_right.setText(array.texts6[numRight]); //Достаём из массива текст
