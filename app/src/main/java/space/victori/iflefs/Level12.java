...
public class Level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource((R.drawable.previewimg12));

        //Установка картинки в диалоговый фон
        LinearLayout previewimgfon= (LinearLayout) dialog.findViewById(R.id.dialogfon);
        previewimgfon.setBackgroundResource((R.drawable.previewbackground12));
        ...
        previewimgfonend.setBackgroundResource((R.drawable.previewbackground12));
        ...
        previewimgfonpause.setBackgroundResource((R.drawable.previewbackground12));
        ...
        img_left.setImageResource(array.images12[numLeft]);//Достаём из массива картинку
        ...
        text_right.setText(array.texts12[numRight]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==15){//ВЫХОД ИЗ УРОВНЯ
                        ...
                        text_left.setText(array.texts12[numLeft]);
                        ...
                        img_right.setImageResource(array.images12[numRight]);//Достаём из массива картинку
